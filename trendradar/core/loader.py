...
def _load_ai_config(config_data: Dict) -> Dict:
    ...
    return {
        ...
        "API_KEY": _get_env_str("AI_API_KEY") or _get_env_str("ARK_API_KEY") or ai_config.get("api_key", ""),
        "API_BASE": _get_env_str("AI_API_BASE") or _get_env_str("ARK_API_BASE") or ai_config.get("api_base", ""),
